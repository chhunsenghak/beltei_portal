...
-- ============================================================
-- GRANTS
-- Supabase requires explicit table-level grants even when RLS is
-- enabled. RLS policies restrict which *rows* are visible; grants
-- control which *operations* are allowed at all.
-- ============================================================

GRANT USAGE ON SCHEMA public TO anon, authenticated;

-- Authenticated users: full DML on every table; RLS policies enforce
-- row-level restrictions so this is safe.
